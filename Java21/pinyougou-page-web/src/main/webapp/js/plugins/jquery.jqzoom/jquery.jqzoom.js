  ...
  $.fn.jqueryzoom = function (options) {
    ...
    $(this).hover(function () {
      ...
      if (settings.position == "right") {
        ...
        if (imageLeft + imageWidth + settings.offset + settings.xzoom
            > screen.width) {
      ...
      $(document.body).mousemove(function (e) {
        ...
        if (settings.lens) {
          ...
          xpos = (mouse.x - $("div.jqZoomPup").width() / 2 < imageLeft) ? 0
              : (mouse.x + $("div.jqZoomPup").width() / 2 > imageWidth
                  + imageLeft) ? (imageWidth - $("div.jqZoomPup").width() + 8)
                  : xpos;

          ypos = (mouse.y - $("div.jqZoomPup").height() / 2 < imageTop) ? 0
              : (mouse.y + $("div.jqZoomPup").height() / 2 > imageHeight
                  + imageTop) ? (imageHeight - $("div.jqZoomPup").height() + 8)
                  : ypos;
