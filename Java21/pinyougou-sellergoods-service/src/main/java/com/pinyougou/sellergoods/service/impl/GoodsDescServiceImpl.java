...
public class GoodsDescServiceImpl implements GoodsDescService {
  ...
  public PageResult findPage(TbGoodsDesc goodsDesc, int pageNum, int pageSize) {
    ...
    if (goodsDesc != null) {
      ...
      if (goodsDesc.getSpecificationItems() != null
          && goodsDesc.getSpecificationItems().length() > 0) {
        criteria.andSpecificationItemsLike("%" + goodsDesc.getSpecificationItems() + "%");
      }
      if (goodsDesc.getCustomAttributeItems() != null
          && goodsDesc.getCustomAttributeItems().length() > 0) {
