...
(function ($, undefined) {
  ...
  function ajax(options) {
    ...
    return function (query) {
      ...
      timeout = window.setTimeout(function () {
        ...
        data = data ? data.call(self, query.term, query.page, query.context)
            : null;
        url = (typeof url === 'function') ? url.call(self, query.term,
            query.page, query.context) : url;
  ...
  function defaultTokenizer(input, selection, selectCallback, opts) {
    ...
    while (true) {
      ...
      if (token.length > 0) {
        ...
        if (token !== undefined && token !== null && opts.id(token)
            !== undefined && opts.id(token) !== null) {
          dupe = false;
  ...
  AbstractSelect2 = clazz(Object, {
    ...
    init: function (opts) {
      ...
      this.containerId = "s2id_" + (opts.element.attr("id") || "autogen"
          + nextUid());
      ...
      this.dropdown.on("touchstart touchmove touchend", resultsSelector,
          this.bind(function (event) {
            this._touchEvent = true;
            this.highlightUnderEvent(event);
          }));
      this.dropdown.on("touchmove", resultsSelector,
          this.bind(this.touchMoved));
      this.dropdown.on("touchstart touchend", resultsSelector,
      ...
      if ($.fn.mousewheel) {
        results.mousewheel(function (e, delta, deltaX, deltaY) {
          ...
          if (deltaY > 0 && top - deltaY <= 0) {
            results.scrollTop(0);
            killEvent(e);
          } else if (deltaY < 0 && results.get(0).scrollHeight
              - results.scrollTop() + deltaY <= results.height()) {
    ...
    optionToData: function (element) {
      if (element.is("option")) {
        return {
          ...
          locked: equal(element.attr("locked"), "locked") || equal(
    ...
    prepareOpts: function (opts) {
      ...
      if (select) {
        ...
        $.each(["id", "multiple", "ajax", "query", "createSearchChoice",
      ...
      opts = $.extend({}, {
        populateResults: function (container, results, query) {
          ...
          populate = function (results, container, depth) {
            ...
            var i, l, result, selectable, disabled, compound, node, label,
            ...
            for (i = 0, l = results.length; i < l; i = i + 1) {
              ...
              node.addClass(selectable ? "select2-result-selectable"
      ...
      if (typeof (opts.query) !== "function") {
        throw "query function not defined for Select2 " + opts.element.attr(
            "id");
      }
    ...
    positionDropdown: function () {
      ...
      if (this.opts.dropdownAutoWidth) {
        ...
        dropWidth = $dropdown.outerWidth(false) + (resultsListNode.scrollHeight
        === resultsListNode.clientHeight ? 0 : scrollBarDimensions.width);
    ...
    close: function () {
      ...
      this.dropdown.hide();
      this.container.removeClass("select2-dropdown-open").removeClass(
          "select2-container-active");
      this.results.empty();
    ...
    moveHighlight: function (delta) {
      ...
      while (index > -1 && index < choices.length) {
        ...
        if (choice.hasClass("select2-result-selectable") && !choice.hasClass(
            "select2-disabled") && !choice.hasClass("select2-selected")) {
      ...
      if (below <= this.opts.loadMorePadding) {
        ...
        this.opts.query({
          ...
          callback: this.bind(function (data) {
            ...
            if (data.more === true) {
              more.detach().appendTo(results).text(
                  evaluate(self.opts.formatLoadMore, page + 1));
              window.setTimeout(function () {
    ...
    updateResults: function (initial) {
      ...
      function postRender() {
        ...
        self.positionDropdown();
        if (results.find(
            '.select2-no-results,.select2-selection-limit,.select2-searching').length) {
          self.liveRegion.text(results.text());
        } else {
          self.liveRegion.text(self.opts.formatMatches(
              results.find('.select2-result-selectable').length));
        }
      }
      ...
      if (maxSelSize >= 1) {
        data = this.data();
        if ($.isArray(data) && data.length >= maxSelSize && checkFormatter(
            opts.formatSelectionTooBig, "formatSelectionTooBig")) {
          render("<li class='select2-selection-limit'>" + evaluate(
      ...
      if (search.val().length < opts.minimumInputLength) {
        if (checkFormatter(opts.formatInputTooShort, "formatInputTooShort")) {
          render("<li class='select2-no-results'>" + evaluate(
      ...
      if (opts.formatSearching && this.findHighlightableChoices().length
          === 0) {
        render("<li class='select2-searching'>" + evaluate(opts.formatSearching)
            + "</li>");
      }
      ...
      opts.query({
        ...
        callback: this.bind(function (data) {
          ...
          if (this.opts.createSearchChoice && search.val() !== "") {
            def = this.opts.createSearchChoice.call(self, search.val(),
                data.results);
            if (def !== undefined && def !== null && self.id(def) !== undefined
                && self.id(def) !== null) {
          ...
          if (data.results.length === 0 && checkFormatter(opts.formatNoMatches,
              "formatNoMatches")) {
            render("<li class='select2-no-results'>" + evaluate(
          ...
          if (data.more === true && checkFormatter(opts.formatLoadMore,
              "formatLoadMore")) {
            results.append(
                "<li class='select2-more-results'>" + self.opts.escapeMarkup(
                evaluate(opts.formatLoadMore, this.resultsPage)) + "</li>");
            window.setTimeout(function () {
              self.loadMoreIfNeeded();
            }, 10);
          }
    ...
    blur: function () {
      ...
      this.clearSearch();
      this.selection.find(".select2-search-choice-focus").removeClass(
    ...
    getPlaceholder: function () {
      ...
      return this.opts.element.attr("placeholder") ||
          ...
          ((placeholderOption = this.getPlaceholderOption()) !== undefined
              ? placeholderOption.text() : undefined);
    },
    ...
    initContainerWidth: function () {
      function resolveContainerWidth() {
        ...
        } else if (this.opts.width === "copy" || this.opts.width
            === "resolve") {
  ...
  SingleSelect2 = clazz(AbstractSelect2, {
    ...
    initContainer: function () {
      ...
      selection.find(".select2-chosen").attr("id",
        ...
        this.opts.initSelection.call(null, this.opts.element,
            function (selected) {
              if (selected !== undefined && selected !== null) {
                ...
                self.close();
                self.setPlaceholder();
                self.nextSearchTerm = self.opts.nextSearchTerm(selected,
                    self.search.val());
              }
            });
      }
    ...
    prepareOpts: function () {
      ...
      if (opts.element.get(0).tagName.toLowerCase() === "select") {
        ...
        opts.initSelection = opts.initSelection || function (element,
            callback) {
          var id = element.val();
    ...
    setPlaceholder: function () {
      ...
      if (this.isPlaceholderOptionSelected() && placeholder !== undefined) {
        ...
        this.selection.find(".select2-chosen").html(
            this.opts.escapeMarkup(placeholder));
    ...
    showSearch: function (showSearchInput) {
      ...
      $(this.dropdown, this.container).toggleClass("select2-with-searchbox",
          showSearchInput);
    },
    ...
    updateSelection: function (data) {
      ...
      var container = this.selection.find(".select2-chosen"), formatted,
          cssClass;
      ...
      this.search.on("keydown", this.bind(function (e) {
        ...
        if (selected.length &&
            (e.which == KEY.LEFT || e.which == KEY.RIGHT || e.which
                == KEY.BACKSPACE || e.which == KEY.DELETE || e.which
                == KEY.ENTER)) {
          ...
          this.selectChoice(selection.find(
              ".select2-search-choice:not(.select2-locked)").last());
          killEvent(e);
          return;
        } else {
    ...
    onSelect: function (data, options) {
      ...
      if (this.select || !this.opts.closeOnSelect) {
        this.postprocessResults(data,
            false, this.opts.closeOnSelect === true);
      }
    ...
    postprocessResults: function (data, initial, noHighlightUpdate) {
      ...
      choices.each2(function (i, choice) {
        ...
        if (indexOf(id, val) >= 0) {
          ...
          choice.find(".select2-result-selectable").addClass(
              "select2-selected");
        }
      });
      ...
      compound.each2(function (i, choice) {
        ...
        if (!choice.is('.select2-result-selectable')
            && choice.find(
                ".select2-result-selectable:not(.select2-selected)").length
            === 0) {
          choice.addClass("select2-selected");
        }
      });
      ...
      if (!this.opts.createSearchChoice && !choices.filter(
          '.select2-result:not(.select2-selected)').length > 0) {
        if (!data || data && !data.more && this.results.find(
            ".select2-no-results").length === 0) {
          if (checkFormatter(self.opts.formatNoMatches, "formatNoMatches")) {
            this.results.append("<li class='select2-no-results'>" + evaluate(
  ...
  $.fn.select2 = function () {
    ...
    var args = Array.prototype.slice.call(arguments, 0),
        ...
        allowedMethods = ["val", "destroy", "opened", "open", "close", "focus",
    ...
    this.each(function () {
      if (args.length === 0 || typeof (args[0]) === "object") {
        ...
        select2 = multiple ? new window.Select2["class"].multi()
  ...
  $.fn.select2.defaults = {
    ...
    matcher: function (term, text) {
      return stripDiacritics('' + text).toUpperCase().indexOf(
          stripDiacritics('' + term).toUpperCase()) >= 0;
    },
    separator: ",",
    tokenSeparators: [],
