						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" ng-click="addSkuToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeItemsList as customAttributeItems>
										<#if customAttributeItems.value??>
											<li>${customAttributeItems.text}:${customAttributeItems.value}</li>
										</#if>
									</#list>
								</ul>
